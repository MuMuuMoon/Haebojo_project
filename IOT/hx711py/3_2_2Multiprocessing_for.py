...
while True:
    try:
        ...
        # t1= Process(target= loadcell1(first1), args=(first1))
        # t2= Process(target= loadcell2(first2), args=(first2))
        # # t3= Process(target= loadcell3(first3), args=(first3))
        # t1.start()
        # t2.start()
        # t3.start()
        ...
        c1=Process(target=check1())
        c2=Process(target=check2())
        c3=Process(target=check3())
        c1.start()
        c2.start()
        c3.start()
